...
<sld:StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:sld="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml" version="1.0.0">
    <sld:UserLayer>
        ...
        <sld:UserStyle>
            <sld:Name>Route1 Hoganas Faaborg</sld:Name>
            <sld:FeatureTypeStyle>
                ...
                <sld:Rule>
                    ...
                    <sld:LineSymbolizer>
                        <sld:Stroke>
                            <sld:CssParameter name="stroke">#0080C0</sld:CssParameter>
                            <sld:CssParameter name="stroke-width">3.0</sld:CssParameter>
                        </sld:Stroke>
                    </sld:LineSymbolizer>
                    <sld:TextSymbolizer>
                        <sld:Label>
                            <ogc:PropertyName>dist_km</ogc:PropertyName>
                        </sld:Label>
                        <sld:Font>
                        ...
                        <sld:Fill>
                            <sld:CssParameter name="fill">#804040</sld:CssParameter>
                        </sld:Fill>
                    </sld:TextSymbolizer>
                </sld:Rule>
            </sld:FeatureTypeStyle>
